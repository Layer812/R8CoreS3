...
if btnp(2)then B=not B end?B and"on!"or"off",100,50,B and 11or 8
if btnp(1)then g=not g end?g and"on!"or"off",100,60,g and 11or 8
if btnp(0)then k=not k end?k and"on!"or"off",100,70,k and 11or 8
...
if B or g or k then?"cheats",50,90,12
?"active",50,100,12
...
local e=95if m then for n=1,#m do?m[n],34,e,10
e=e+10end end if N then?N,29,e,10
...
local e=34if m then for n=1,#m do local n=m[n]local l=#n*4 local l=(128-l)/2?n,l,e,10
...
if flr(A/1500)+r>=16then?"balls for next stage: 16 (max!)",2,75,7
else?"balls for next stage: "..flr(A/1500)+r,15,75,7
end if eh==8then?"hint: easter egg on start screen",0,95,12
end if J==29then?"stage 100% cleared!",28,110,7
...
if e[4]then spr(e[4],3,e[2]-2)end end?"prevous page 0 1 next page",8,120,7
