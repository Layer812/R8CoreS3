...
version 42
__lua__
local o,l,a,f,d,i,r,s,h,c,u,p,b,_,m,g,w,v,k,x,j,q,B,C,E,A,D,F,H,I,K,L,y,G,J,M,N,O,Q,P,R,T,S,V,X,Y,z,W,Z,el,et,e1,no,U,en,eo,ea,e0,ei,ed,ef,er,es,ec,eu,e5,ep,e7,ee,eh,e2,e8,eb,e6,e_,em,e4,eg,e3,ew,ev,ek,ex,ey,ej,eq,ez,eA,eB,eC,eD,eE,eG,e9,eF,eH,eI,eJ,eK,eL,eM,eN,eO,eP,eQ,eR,eS,eT,eU,eV
local n="start_screen"p=nil h=true local e=false q=nil f=nil function _init()ef()Z()f=nil cartdata"maxosirus_pegball_data"local e={[0]=0,[1]=0,[3]=0,[4]=0,[5]=0,[6]=0,[7]=0,[8]=0,[9]=0,[10]=0,[11]=0,[12]=0}for e,n in pairs(e)do if dget(e)==0then dset(e,n)end end end function _update60()if n=="start_screen"then ee()if btnp(⬆)then h=not h elseif btnp(➡)then music(-1)e=false ef()Z()eb()er()d=0if h then n="power_choice"else n="classic"end p="classic"elseif btnp(⬅)then music(-1)e=false ef()Z()eb()er()d=0if h then n="power_choice"else n="time_trial"end p="time_trial"elseif btnp(⬇)then n="how_to_1"elseif btnp(❎)and btnp(🅾)then n="easter_egg"end elseif n=="power_choice"then if en>0then sfx(0)eH()en=en-1else if btnp(⬆)then v=1z=b.x n=p elseif btnp(➡)then v=2z=b.y n=p elseif btnp(⬅)then v=3z=b.j n=p elseif btnp(❎)then v=4z=b.D n=p elseif btnp(🅾)then v=5z=b.E n=p elseif btnp(⬇)then v=6z=b.F n=p end end elseif n=="how_to_1"then if btnp(⬆)then n="how_to_2"end elseif n=="how_to_2"then if btnp(➡)then n="how_to_3"elseif btnp(⬅)then n="how_to_1"end elseif n=="how_to_3"then if btnp(⬅)then n="how_to_2"elseif btnp(❎)then n="start_screen"end elseif n=="classic"or n=="time_trial"then e6()eI()eJ()el=0e9()eK()if f and f.o=="gravity_flip"then if o.r then if F>0then F=F-1else n="pause"end end end if f and f.o=="reshoot"then if G>0then G=G-1else n="pause"end end if f and f.o=="ball_start"and not o.r then H=H+1if H>=15then local e={26,51,77,102}o.l=e[flr(rnd(#e))+1]H=0end end if o.r then if o.a=="multiball"then for e=1,#s do local e=s[e]e_(e,i)end em(o)else e_(o,i)em(o)end end if n=="classic"or n=="time_trial"then p=n end if r<=0and c<20and not o.r then n=p=="classic"and"game_over"or"trial_lost"elseif c==20then if f then if f.o=="multiball"then local e=true for n=1,#s do local n=s[n]if not n.q then e=false break end end if e and(o.e>128or o.h>=120)then l=true n="pause"end elseif f.o=="expansion"then if not I and(o.e>128or o.h>=120)or o.t>=20then l=true I=false n="pause"end elseif f.o=="gravity_flip"then if o.r then if F<=0then l=true n="pause"elseif o.e>128then l=true n="pause"elseif o.h>=120then l=true n="pause"elseif(o.e>128or o.h>=120)and btn(❎)and abs(o.d)<.1then l=true n="pause"end end elseif f.o=="reshoot"then if G<=0then l=true n="pause"elseif o.e>128or o.h>=120then l=true n="pause"end elseif f.o=="rock_drop"then if o.r then local e=abs(o.i)<.01and abs(o.d-.08)<.01if o.e>128then l=true n="pause"elseif o.h>=120and e then l=true n="pause"end end elseif f.o=="magnet"then if o.e>128or o.h>=120then l=true n="pause"end elseif f.o=="boulder"then if o.e>128or o.h>=120then l=true n="pause"end else if o.e>128or o.h>=120then l=true n="pause"end end else if o.e>128or o.h>=120then l=true n="pause"end end end elseif n=="pause"then sfx(-1,et)e6()es=false F=k and 3660or 1830G=k and 3660or 1830eh=flr(rnd(10))+1if not eo then e4()eo=true end ea=ea+1if ea>=90then ea=0A=A+d if u+d<10000then u=u+d else local e=u+d _=_+flr(e/10000)u=e%10000end eL()e9()eM()d=0eo=false if l then l=false n=p=="classic"and"stage_clear"or"time_trial_complete"else n=p or"classic"end end elseif n=="game_over"or n=="trial_lost"then ec()d=0ee()if not M then eg()M=true end if btnp(❎)or btnp(🅾)then m,N,M=nil,nil,false e3()end elseif n=="time_trial_complete"then ec()d=0ee()ew()if not M then eg()M=true end if btnp(❎)or btnp(🅾)then m,N,M=nil,nil,false e3()end elseif n=="stage_clear"then ec()d=0ee()ew()if btnp(🅾)then music(-1)eN()ev()Z()ek()A=0d=0if not f then o.c=6end O=O+1en=90e2=e2+1if e2%3==0and h then n="power_choice"else n=p end end end end function _draw()cls(1)if n=="start_screen"then eO()elseif n=="classic"or n=="time_trial"then eP()ex()ey()if n=="classic"then print("score:"..P.._..Q..u,10,0,7) 
...
if btnp(⬇)then n="start_screen"end if btnp(❎)and btnp(⬇)then for e=0,12do dset(e,0)end end end}if e[n]then e[n]()end end end B,g,k,eh=false,false,false,nil function eb()if B==true then r=r+6end end function ef()ev()r,u,O,e2,_=10,0,1,0,0P,Q,m,N="00000","0000",nil,nil eZ,es,nd,ni,M=false,false,false,false,false x,C,F,G,en,v=64,2,1830,1830,90,nil end function ev()cls()o.l,o.e,o.i,o.d=64,10,0,0o.r,a=false,.75A,eo,nf,c=0,false,0,0o._,o.m,o.h=o.l,o.e,0S,eC,eu,J,eh=0,nil,false,0,nil local e={G=4,H=14,I=6,J=13,K=10,L=3,M=2,N=0,O=8,P=7}o.c=e[o.a]or 6if o.a=="boulder"then o.t=8elseif g then o.t=5else o.t=2end end function e3()er()d,n,p=0,"start_screen",nil end function eO()cls(2) print("pegball",50,5,7) 
...
e5(b.x,18,10) print("medium risk/reward press ➡",10,21,7) 
e5(b.y,18,29) print("low risk/reward press ⬅",10,40,7) 
e5(b.j,18,48) print("overdrive press ❎",10,59,7) 
...
end end function ez()rectfill(0,0,8,128,0)spr(48,0,2)for e=8,112,8do spr(49,0,e)end spr(49,0,115)spr(50,0,119)end function ej()rectfill(7,-1,8,130,0)rectfill(120,-1,121,130,0)rectfill(-1,-2,129,-1,0)for e=8,18,9do rectfill(120,e,129,e+1,0)end for e=0,19do local n=127-e*5.45rectfill(126,flr(n),128,flr(n-3.45),e<c and 9or 7)end end function e9()P=_<10and"000"or _<100and"00"or _<1000and"0"or""Q=u<10and"000"or u<100and"00"or u<1000and"0"or""end function eQ()cls(1) print("⬅ aim left   aim right ➡",15,50,7) 
