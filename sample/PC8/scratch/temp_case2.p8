...
version 42
__lua__
local n="start_screen"u=nil r=true local e=false q=nil f=nil function _init()ef()Z()f=nil cartdata"maxosirus_pegball_data"local e={[0]=0,[1]=0,[3]=0,[4]=0,[5]=0,[6]=0,[7]=0,[8]=0,[9]=0,[10]=0,[11]=0,[12]=0}for e,n in pairs(e)do if dget(e)==0 then dset(e,n)end end end function _update60()if n=="start_screen"then ee()if btnp(⬆)then r=not r elseif btnp(➡)then music(-1)e=false ef()Z()eb()er()i=0 if r then n="power_choice"else n="classic"end u="classic"elseif btnp(⬅)then music(-1)e=false ef()Z()eb()er()i=0 if r then n="power_choice"else n="time_trial"end u="time_trial"elseif btnp(⬇)then n="how_to_1"elseif btnp(❎)and btnp(🅾)then n="easter_egg"end elseif n=="power_choice"then if en>0 then sfx(0)eH()en=en-1 else if btnp(⬆)then v=1 z=p.x n=u elseif btnp(➡)then v=2 z=p.y n=u elseif btnp(⬅)then v=3 z=p.j n=u elseif btnp(❎)then v=4 z=p.D n=u elseif btnp(🅾)then v=5 z=p.E n=u elseif btnp(⬇)then v=6 z=p.F n=u end end elseif n=="how_to_1"then if btnp(⬆)then n="how_to_2"end elseif n=="how_to_2"then if btnp(➡)then n="how_to_3"elseif btnp(⬅)then n="how_to_1"end elseif n=="how_to_3"then if btnp(⬅)then n="how_to_2"elseif btnp(❎)then n="start_screen"end elseif n=="classic"or n=="time_trial"then e6()eI()eJ()el=0e9()eK()if f and f.o=="gravity_flip"then if o.r then if E>0 then E=E-1 else n="pause"end end end if f and f.o=="reshoot"then if F>0 then F=F-1 else n="pause"end end if f and f.o=="ball_start"and not o.r then G=G+1 if G>=15 then local e={26,51,77,102}o.l=e[flr(rnd(#e))+1]G=0 end end if o.r then if o.a=="multiball"then for e in all(b)do e_(e,s)end em(o)else e_(o,s)em(o)end end if n=="classic"or n=="time_trial"then u=n end if d<=0 and h<20 and not o.r then n=u=="classic"and"game_over"or"trial_lost"elseif h==20 then if f then if f.o=="multiball"then local e=true for n in all(b)do if not n.q then e=false break end end if e and(o.e>128 or o.h>=120)then l=true n="pause"end elseif f.o=="expansion"then if not H and(o.e>128 or o.h>=120)or o.t>=20 then l=true H=false n="pause"end elseif f.o=="gravity_flip"then if o.r then if E<=0 then l=true n="pause"elseif o.e>128 then l=true n="pause"elseif o.h>=120 then l=true n="pause"elseif(o.e>128 or o.h>=120)and btn(❎)and abs(o.i)<.1 then l=true n="pause"end end elseif f.o=="reshoot"then if F<=0 then l=true n="pause"elseif o.e>128 or o.h>=120 then l=true n="pause"end elseif f.o=="rock_drop"then if o.r then local e=abs(o.d)<.01 and abs(o.i-.08)<.01 if o.e>128 then l=true n="pause"elseif o.h>=120 and e then l=true n="pause"end end elseif f.o=="magnet"then if o.e>128 or o.h>=120 then l=true n="pause"end elseif f.o=="boulder"then if o.e>128 or o.h>=120 then l=true n="pause"end else if o.e>128 or o.h>=120 then l=true n="pause"end end else if o.e>128 or o.h>=120 then l=true n="pause"end end end elseif n=="pause"then sfx(-1,et)e6()es=false E=k and 3660 or 1830 F=k and 3660 or 1830 eh=flr(rnd(10))+1 if not eo then e4()eo=true end ea=ea+1 if ea>=90 then ea=0 A=A+i if c+i<10000 then c=c+i else local e=c+i _=_+flr(e/10000)c=e%10000 end eL()e9()eM()i=0 eo=false if l then l=false n=u=="classic"and"stage_clear"or"time_trial_complete"else n=u or"classic"end end elseif n=="game_over"or n=="trial_lost"then e2()i=0 ee()if not L then eg()L=true end if btnp(❎)or btnp(🅾)then m,M,L=nil,nil,false e3()end elseif n=="time_trial_complete"then e2()i=0 ee()ew()if not L then eg()L=true end if btnp(❎)or btnp(🅾)then m,M,L=nil,nil,false e3()end elseif n=="stage_clear"then e2()i=0 ee()ew()if btnp(🅾)then music(-1)eN()ev()Z()ek()A=0 i=0 if not f then o.c=6 end N=N+1 en=90 ec=ec+1 if ec%3==0 and r then n="power_choice"else n=u end end end end function _draw()cls(1)if n=="start_screen"then eO()elseif n=="classic"or n=="time_trial"then eP()ex()ey()if n=="classic"then print("score:"..O.._..P..c,10,0,7) 
...
if btnp(⬆)then B=not B end print(B and"on!"or"off",100,50,B and 11 or 8) 
if btnp(➡)then g=not g end print(g and"on!"or"off",100,60,g and 11 or 8) 
if btnp(⬅)then k=not k end print(k and"on!"or"off",100,70,k and 11 or 8) 
if btnp(⬇)then n="start_screen"end if btnp(❎)and btnp(⬇)then for e=0,12 do dset(e,0)end end end}if e[n]then e[n]()end end end B,g,k,eh=false,false,false,nil function eb()if B==true then d=d+6 end end function ef()ev()d,c,N,ec,_=10,0,1,0,0 O,P,m,M="00000","0000",nil,nil eZ,es,nd,n1,L=false,false,false,false,false x,C,E,F,en,v=64,2,1830,1830,90,nil end function ev()cls()o.l,o.e,o.d,o.i=64,10,0,0 o.r,a=false,.75 A,eo,nf,h=0,false,0,0 o._,o.m,o.h=o.l,o.e,0 R,eC,eu,I,eh=0,nil,false,0,nil local e={G=4,H=14,I=6,J=13,K=10,L=3,M=2,N=0,O=8,P=7}o.c=e[o.a]or 6 if o.a=="boulder"then o.t=8 elseif g then o.t=5 else o.t=2 end end function e3()er()i,n,u=0,"start_screen",nil end function eO()cls(2) print("pegball",50,5,7) 
